...
#define POPULATION 64          // Adjust according to the population size  >= 4
...
#define MAX_BURST_FEATURES 5000 // Adjust according to the maximum amount of samples to process in 1 burst
#define NULL_VOTE -1
